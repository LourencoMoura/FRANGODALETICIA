...
export const promotionTipoEnum = pgEnum("promotion_tipo", [
  "percentual",
  "fixo",
]);
...
export const admins = pgTable(
  ...
  table => [index("admins_email_unique").on(table.email)]
);
...
export const customers = pgTable(
  ...
  table => [index("customers_whatsapp_unique").on(table.whatsapp)]
);
...
export const pushSubscriptions = pgTable(
  ...
  table => [index("push_subscriptions_customer_id").on(table.customerId)]
);
