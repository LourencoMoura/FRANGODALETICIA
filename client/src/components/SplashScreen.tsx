...
export function SplashScreen() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center" style={{ backgroundColor: '#fcfcff' }}>
      {/* Background pattern */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-6 px-4">
        ...
        <div className="text-center mt-6">
          <div className="text-3xl md:text-4xl font-black mb-2" style={{
        ...
        <div className="mt-8 flex gap-2">
          <div className="w-2 h-2 bg-orange-600 rounded-full animate-bounce" style={{ animationDelay: '0s' }} />
          <div className="w-2 h-2 bg-orange-600 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }} />
          <div className="w-2 h-2 bg-orange-600 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }} />
        </div>
      </div>
    </div>
  );
